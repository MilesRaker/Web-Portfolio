...
const  Education = (props) => {
    return(
        <Grid item id={"education"} className={"resume-section"} xs={12}>
            <Typography variant={"h4"} className="sectionHeadings">Education</Typography>
            <Accordion className="resume-item">
                <AccordionSummary
                ...
                >
                    <div>
                        <Typography className="accordion-title" >CodeUp</Typography>
                        <Typography className="accordion-subtitle" >Full Stack Web Design</Typography>
                    </div>
                </AccordionSummary>
                <AccordionDetails
                    className={"education-accordion-details"}>
                    <Typography>
